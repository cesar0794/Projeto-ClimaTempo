...
class WeatherApp(QWidget):
    def __init__(self):
        ...
        self.get_weather_button = QPushButton("Consultar Clima", self)
    ...
    def initUI(self):
        self.setWindowTitle("Clima Tempo Cesar")
    ...
    def get_weather(self):
        ...
        try: 
            ...
            match response.status_code:
                ...
                case 401:
                    self.display_error("Não autorizado\nChave da API invalida")     
                case 403:
                    self.display_error("Acesso negado\nAcesso negado") 
                case 404:
                    self.display_error("Não encontrado: \nCidade não encontrada")    
                case 500:
                    self.display_error("Erro de servidor interno\nTente novamente mais tarde")    
                case 502:
                    self.display_error("Bad Gateway\nResposta inválida do servidor")                                        
                case 503:
                    self.display_error("Serviço não disponivel\nServidor offline")    
                case 504:
